...
type TargetReport = { ready: boolean; target: string; state?: "recovery-required" | "orphan-cleanup-available" | "already-installed" | "lifecycle-unavailable"; deploymentId?: string; checks: { name: string; ok: boolean; message: string }[] };
